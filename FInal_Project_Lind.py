...
#___________________________________________visualize_data__________________________________________

#I am using a seaborn's heatmap to show correlation for some variables I think might best influence a pos return. 
df1 = val_returns.filter(['AVG_RETURN_FLUC', 'NICHE', 'COMMUNITY_INVOLV', 'RESEARCH_INNOVATION', 'FINANCIAL_SLACK', 
	'CORP_GOV', 'CEO_AWARDS', 'PRESS_RELEASES', 'PERCIEVED_RISK', 'CLOSE_COMPETITORS','MISSION_VISION'], axis =1);
